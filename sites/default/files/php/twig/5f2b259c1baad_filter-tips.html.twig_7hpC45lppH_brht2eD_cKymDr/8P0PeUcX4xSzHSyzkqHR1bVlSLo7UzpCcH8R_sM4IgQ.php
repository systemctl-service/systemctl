...
class __TwigTemplate_80c294618528e2192cb41465d1a7fb93d043a9573210bead2c6ca2fd9b35703b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "C:\\wamp64\\www\\systemctl\\core\\themes\\seven\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
}
